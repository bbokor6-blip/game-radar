import { conferenceForTeam } from "./conferences";
const SOURCES = {
...
function normalizeEvent(event, sport) {
  ...
  return {
    ...
    home: { id: home.id, name: home.team?.displayName || "Home", short: home.team?.abbreviation || home.team?.shortDisplayName || "HOME", logo: home.team?.logo || null, score: num(home.score), rank: rankOf(home), record: recordOf(home), conference: sport==="cfb"?conferenceForTeam(home.team):null },
    away: { id: away.id, name: away.team?.displayName || "Away", short: away.team?.abbreviation || away.team?.shortDisplayName || "AWAY", logo: away.team?.logo || null, score: num(away.score), rank: rankOf(away), record: recordOf(away), conference: sport==="cfb"?conferenceForTeam(away.team):null }
  };
}
